...
public class Research_Security_Page {
	...
	public static void main (final String[] args) throws Exception
	{
		...
		String research_security_header = "mega-menu-item-17832";
		...
		//clicks the security
		driver.findElement(By.id(research_security_header)).click();

		heading = driver.findElement(By.xpath("//div[@id='main-content']//h1[text()='Artificial Intelligence:']")).isDisplayed();
		if(heading)
			System.out.println("Security Landed correctly");
		else
			System.out.println("Security Landed INcorrectly");
		...
		//Returns back to the Research Security Page
		hover.moveToElement(driver.findElement(By.id(research_path))).build().perform();
		driver.findElement(By.id(research_security_header)).click();
		...
		heading = driver.findElement(By.xpath("//article[@id='post-23489']//h2[text()='Customer Review/Testimonial – Basra Security']")).isDisplayed();
