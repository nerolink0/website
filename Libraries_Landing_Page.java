...
public class Libraries_Landing_Page {
	...
	public static void main (final String[] args) throws Exception
	{
		...
		//Link on the heading
		String self_schedule_landingpage = "//div[@id='main-content']//a[text()='self-schedule']";
		...
		String absenteeism_link_1 = "//div[@id='absenteeism']//a[text()='Absenteeism']";
		...
		//Clicks the Libraries from the Industries Header
		driver.findElement(By.id(Libraries_header)).click();

		//Clicks the "Self-Schedule" link on the landing page heading
		driver.findElement(By.xpath(self_schedule_landingpage)).click();
		heading = driver.findElement(By.xpath(self_scheduling_pageheading)).isDisplayed();

		if(heading)
			System.out.println("Self-Schedule link in Libraries Page is PRESENT");

		//returns back to the Libraries Landing page
		driver.get("https://www.celayix.com/industries/library-staff-scheduling-software/");
		...
		//Finding and clicking the subsections of the Libraries landing page
		...
		hover.moveToElement(driver.findElement(By.xpath(scheduling))).build().perform();
		...
		if(heading)
			System.out.println("Link 4-1 is PRESENT");
		//returns back to the Libraries Landing page
		driver.get("https://www.celayix.com/industries/library-staff-scheduling-software/");
		...
		if(heading)
			System.out.println("Link 4-2 is PRESENT");
		//returns back to the Libraries Landing page
		driver.get("https://www.celayix.com/industries/library-staff-scheduling-software/");
		...
		//link6
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(time_attendance_2))).click();
		heading = driver.findElement(By.xpath(time_attendance_pageheading)).isDisplayed();
