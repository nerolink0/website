...
public class Hospitality_Landing_Page {
	...
	public static void main (final String[] args) throws Exception
	{
		...
		String machine_learning_subsection = "//div[@id='benefits']//a[text()='Machine-learning']";
		...
		String celayix_ai_absenteeism = "//div[@id='absenteeism']//a[text()='Celayix AI']";
		...
		String overtime_2 = "//div[@id='overtime']//p[3]//a[text()='overtime']";
		String payroll_time_attendance = "//div[@id='payroll-billing']//a[text()='time & attendance']";
		String payroll_time_attendance_2 = "//div[@id='payroll-billing']//p[3]//a";
		...
		//Clicks the Hospitality from the Industries Header
		...
		//Finding and clicking the subsections of the Hospitality landing page
		...
		//returns back to the Hospitality Landing page
		driver.get("https://www.celayix.com/industries/hospitality-staff-scheduling-software/");
		...
		//SUBLink4
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(machine_learning_subsection))).click();
		heading = driver.findElement(By.xpath(AI_pageheading)).isDisplayed();

		if(heading)
			System.out.println("SUBLink 4 is PRESENT");
		//returns back to the Hospitality Landing page
		driver.get("https://www.celayix.com/industries/hospitality-staff-scheduling-software/");
		...
		//link2
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(celayix_ai_absenteeism))).click();
		heading = driver.findElement(By.xpath(AI_pageheading)).isDisplayed();
		...
		//link9
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(time_attendance_AI))).click();
		heading = driver.findElement(By.xpath(AI_pageheading)).isDisplayed();
