...
public class Research_Hospitality_Page {
	...
	public static void main (final String[] args) throws Exception
	{
		...
		String research_hospitality_header = "mega-menu-item-17835";
		...
		//clicks the Hospitality Health Care
		driver.findElement(By.id(research_hospitality_header)).click();

		heading = driver.findElement(By.xpath("//div[@id='main-content']//h1[text()='Artificial Intelligence:']")).isDisplayed();
		if(heading)
			System.out.println("Hospitality  Landed correctly");
		else
			System.out.println("Hospitality  Landed INcorrectly");
		...
		//Returns back to the Research Hospitality Page
		hover.moveToElement(driver.findElement(By.id(research_path))).build().perform();
		driver.findElement(By.id(research_hospitality_header)).click();
		...
		heading = driver.findElement(By.xpath("//article[@id='post-9788']//h2[text()='Flexible Scheduling for Route Operator Company']")).isDisplayed();
		if(heading)
		...
		heading = driver.findElement(By.xpath("//article[@id='post-23341']//h2[text()='Customer Review/Testimonial – The Sands Expo & Convention Centre']")).isDisplayed();
		...
		Thread.sleep(time);
		heading = driver.findElement(By.xpath("//article[@id='post-8170']//h2[text()='Customer Review/Testimonial – The Sands Expo & Convention Centre']")).isDisplayed();
