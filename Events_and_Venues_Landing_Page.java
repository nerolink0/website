...
public class Events_and_Venues_Landing_Page {
	...
	public static void main (final String[] args) throws Exception
	{
		...
		String events_and_venues_header = "mega-menu-item-28800";
		...
		String ai_recommendations_absenteeism = "//div[@id='absenteeism']//a[text()='AI Recommendations']";
		...
		String time_attendance_GPS = "//div[@id='time-attendance']//a[text()='100% accurate GPS-verified check-in and check-out']";
		//String time_attendance_AI = "//div[@id='time-attendance']//a[text()='AI']";
		...
		String overtime_1 = "//div[@id='overtime']//a[text()='Overtime']";
		String overtime_2 = "//div[@id='overtime']//a[text()='overtime']";
		String overtime_3 = "//div[@id='overtime']//p[3]//a[text()='overtime']";
		String payroll_time_attendance = "//div[@id='payroll-billing']//a[text()='Time & attendance']";
		String payroll_time_attendance_2 = "//div[@id='payroll-billing']//a[text()='time & attendance software']";
		String integration_time_attendance = "//div[@id='integration']//a[text()=' time & attendance']";
		String integration_shift_scheduling = "//div[@id='integration']//a[text()='staff shift-scheduling']";
		...
		//BUTTONS
		String custom_demo_button = "//div[@id='main-content']//a[@class='et_pb_button et_pb_button_1 et_pb_bg_layout_dark']";
		...
		String staff_shift_scheduling_pageheading = "//div[@id='main-content']//h1[text()='Feature Focus: Celayix Employee Scheduling Software']";
		...
		driver.findElement(By.id(events_and_venues_header)).click();
		...
		//returns back to the Events and Venues Landing page
		driver.get("https://www.celayix.com/industries/events-venues-staff-scheduling-software/");
		...
		//link2
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(ai_recommendations_absenteeism))).click();
		...
		//link5
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(overtime_1))).click();
		heading = driver.findElement(By.xpath(overtime_pageheading)).isDisplayed();

		if(heading)
			System.out.println("Link 5-1 is PRESENT");
		//returns back to the Events and Venues Landing page
		driver.get("https://www.celayix.com/industries/events-venues-staff-scheduling-software/");
		...
		if(heading)
			System.out.println("Link 5-2 is PRESENT");
		//returns back to the Events and Venues Landing page
		driver.get("https://www.celayix.com/industries/events-venues-staff-scheduling-software/");


		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(overtime_3))).click();
		heading = driver.findElement(By.xpath(overtime_pageheading)).isDisplayed();

		if(heading)
			System.out.println("Link 5-3 is PRESENT");
		//returns back to the Events and Venues Landing page
		driver.get("https://www.celayix.com/industries/events-venues-staff-scheduling-software/");
		...
		//link13
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(integration_shift_scheduling))).click();
		heading = driver.findElement(By.xpath(staff_shift_scheduling_pageheading)).isDisplayed();
		...
		//link14
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(integration_time_attendance))).click();
		heading = driver.findElement(By.xpath(time_attendance_pageheading)).isDisplayed();
		...
		//Impressed Yet
		driver.findElement(By.xpath("//div[@class='et_pb_section et_pb_section_17 et_pb_with_background et_section_regular']//a//strong[text()='Research']")).click();
		...
		driver.findElement(By.xpath("//div[@class='et_pb_section et_pb_section_17 et_pb_with_background et_section_regular']//a//strong[text()='Pricing']")).click();
		heading = driver.findElement(By.xpath(pricing_pageheading)).isDisplayed();

		if(heading)
			System.out.println("Pricing Link is PRESENT");
		driver.get("https://www.celayix.com/industries/events-venues-staff-scheduling-software/");
		...
		driver.findElement(By.xpath("//div[@id='main-content']//a[@class='et_pb_button et_pb_button_1 et_pb_bg_layout_dark']")).click();
		boolean custom_demo_heading = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='overlay-27985']//h3[text()='Free Live Demo']"))).isDisplayed();

		if(custom_demo_heading)
			System.out.println("Custom Demo form is PRESENT");

		driver.findElement(By.xpath("//div[@id='overlay-27985']//span[@class='custom_btn']")).click();
