...
public class Research_Longterm_Healthcare_Page {
	...
	public static void main (final String[] args) throws Exception
	{
		...
		String research_lonterm_healthcare_header = "mega-menu-item-17834";
		...
		//clicks the Long Term Health Care
		driver.findElement(By.id(research_lonterm_healthcare_header)).click();

		heading = driver.findElement(By.xpath("//div[@id='main-content']//h1[text()='Artificial Intelligence:']")).isDisplayed();
		if(heading)
			System.out.println("Longterm Healtcare Landed correctly");
		else
			System.out.println("Longterm Healtcare Landed INcorrectly");
		...
		//Returns back to the Research Longterm Healtcare Page
		hover.moveToElement(driver.findElement(By.id(research_path))).build().perform();
		driver.findElement(By.id(research_lonterm_healthcare_header)).click();
		...
		heading = driver.findElement(By.xpath("//article[@id='post-11067']//h2[text()='Connecticut Veterans Hospital Eliminates Overtime']")).isDisplayed();
		if(heading)
